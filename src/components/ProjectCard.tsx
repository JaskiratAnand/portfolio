        ...
        <div className="flex flex-col md:grid col-span-6">
          ...
          <div className="flex flex-row gap-4 text-sm font-medium mt-3 text-blue-500">
            ...
            <a
              ...
              target="_blank"
              className="h-7 border flex flex-col justify-center items-center px-2 py-1 rounded-full bg-neutral-100 dark:bg-neutral-700 dark:border-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-800"
            >GitHub Repo</a>
